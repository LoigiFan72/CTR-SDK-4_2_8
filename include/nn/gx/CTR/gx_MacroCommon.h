...
#ifndef NN_GX_CTR_PICA_MACRO_COMMON_H_
#define NN_GX_CTR_PICA_MACRO_COMMON_H_
...
// Command for writing to a floating point register.
...
#endif // NN_GX_CTR_PICA_MACRO_COMMON_H_
