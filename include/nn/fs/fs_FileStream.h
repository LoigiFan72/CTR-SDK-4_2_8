...
#ifndef NN_FS_FS_FILESTREAM_H_
#define NN_FS_FS_FILESTREAM_H_
...
public:
    ...
    */
    nn::Result TryInitialize(const wchar_t* pathName, bit32 openMode) { return detail::FileBase::TryInitialize(pathName, openMode); }
    ...
    */
    nn::Result TryInitialize(const char* pathName, bit32 openMode) { return detail::FileBase::TryInitialize(pathName, openMode); }
