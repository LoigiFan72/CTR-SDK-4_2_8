...
#ifndef NN_SND_CTR_SND_DSP_FX_DELAY_H_
#define NN_SND_CTR_SND_DSP_FX_DELAY_H_
...
public:
    ...
    struct Param
    {
         ...
         */
        Param() : m_DelayTime(250), m_FeedbackGain(0.4f), m_Damping(0.5f), m_IsEnableSurround(false) {}
    };
...
#endif // NN_SND_CTR_SND_DSP_FX_DELAY_H_
