...
#ifndef NN_CRYPTO_CRYPTO_CTRENCRYPTOR_H_
#define NN_CRYPTO_CRYPTO_CTRENCRYPTOR_H_
...
class CtrEncryptor : public Encryptor
{
private:
...
public:
    ...
    */
    static size_t Encrypt(void* pDst, size_t dstSize, const void* pSrc, size_t srcSize,
                            const void* pIv, size_t ivSize, const BlockCipher& c)
    {
        CtrEncryptor<BlockSize> e;
        return e.Encryptor::Encrypt(pDst, dstSize, pSrc, srcSize, pIv, ivSize, c);
    }
...
*/
typedef CtrEncryptor<16>    CtrEncryptor128;
...
#endif /* NN_CRYPTO_CRYPTO_CTRENCRYPTOR_H_ */
