...
#ifndef NN_CRYPTO_CRYPTO_DECRYPTOR_H_
#define NN_CRYPTO_CRYPTO_DECRYPTOR_H_
...
*/
class Decryptor : public CipherMode
{
public:
    Decryptor(){}
    virtual ~Decryptor(){}
...
protected:
    size_t Decrypt(void* pDst, size_t dstSize, const void* pSrc, size_t srcSize,
...
#endif /* NN_CRYPTO_CRYPTO_DECRYPTOR_H_ */
