...
// TORIAEZU: Provisional for transition period
#ifdef  SDK_ASM
...
// inttypes.h does not exist if VS2008, so commented it out.
...
//#endif
    ...
    /*
         Macros and types used with io_register_list_XX.h files
     */
